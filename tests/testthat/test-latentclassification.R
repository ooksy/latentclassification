...
test_that("tests on error message", {
  expect_error(latentclassification(z2, w2, 4), "dimension of both z and w should be 2")
})

test_that("tests on error message", {
  expect_error(latentclassification(z, w, 0), "n_cluster should be at least 2")
})

test_that("tests on error message", {
  expect_error(latentclassification(z, w, 1), "n_cluster should be at least 2")
})
...
test_that("tests on error message", {
  expect_no_error(latentclassification(z, w, 4))
})
